...
function showResult(str) {
  if (str.length==0) {
    ...
    document.getElementById("JSsearch").style.border="0px";
    return;
  }
  var xmlhttp=new XMLHttpRequest();
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("JSsearch").innerHTML=this.responseText;
      document.getElementById("JSsearch").style.border="1px solid #A5ACB2";
    }
  }
